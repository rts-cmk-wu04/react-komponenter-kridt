...
function App() {
  ...
  return (
    <div className="App">
       ...
       {travelContent6.map(content6 => <Latest_news title_news_nature={content6.title_nature} text_news_nature={content6.text_nature} image_news_nature={content6.img_nature} />)}
    </div>
  );
}
